...
`python -m semantic_objects.ingest.cli --ontology watr`) for the classes derived
from the vendored WATR ontology's SHACL shapes. Nothing needs hand customization
