...
Welcome to the **Semantic Objects** library documentation! This library provides a simplified Pythonic interface to complex ontologies in the built environment, particularly ASHRAE Standard 223P.
